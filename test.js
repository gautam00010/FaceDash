...
async function loadFaceAPIModels() {
    await faceapi.nets.tinyFaceDetector.loadFromUri('https://github.com/gautam00010/FaceDash/tree/main/models'); // Load Tiny Face Detector model
    await faceapi.nets.ssdMobilenetv1.loadFromUri('https://github.com/gautam00010/FaceDash/tree/main/models'); // Load SSD MobileNet model
    await faceapi.nets.faceLandmark68Net.loadFromUri('https://github.com/gautam00010/FaceDash/tree/main/models'); // Load Face Landmark model

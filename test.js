...
async function loadFaceAPIModels() {
    await faceapi.nets.tinyFaceDetector.loadFromUri('/FaceDash/models'); // Load Tiny Face Detector model
    await faceapi.nets.ssdMobilenetv1.loadFromUri('/FaceDash/models'); // Load SSD MobileNet model
    await faceapi.nets.faceLandmark68Net.loadFromUri('/FaceDash/models'); // Load Face Landmark model
